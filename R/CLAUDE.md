...
| `37-47, 49-50 + RUN_REVISION.R + revision_helpers.R` | **Phase 3 (revision extras)**: freeze checks (37), CHR bounds (38), expanding-FCI post-IT IV (39), lag-augmented LP (40), placebos (41), FCI LOO battery (42), FRED fetch (43), instrument robustness (44), COVID reclassification (45), shift-share (46), FX-adjustment audit (47), IV/AR scaling audit (49: 2SLS=RF/FS identity, conditional-FS decomposition, AR-at-OLS; Part 4 CHR delta-method interval; Part 5 CHR joint moving-block bootstrap), persistence-valid DXY–FCI assessment (50: unit roots, EG/Johansen, ARDL bounds exact CVs + whitened, pooled UECM pre/post-IT long-run break, weak exogeneity, ex-TCN/rates-only variants → Rev_PV_*.csv, appendix K.1d). See `README_REVISION.md` |
